...
# --- Discord Bot Setup ---
TOKEN = os.getenv("DISCORD_BOT_TOKEN")  # التوكن من Environment
if not TOKEN:
...
async def keep_alive():
    url = "https://info-1-rngw.onrender.com"  # رابط البوت على Render
...
# --- Run Bot ---
async def main():
    asyncio.create_task(keep_alive())  # Keep-Alive task
    async with bot:
